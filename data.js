 ...
 understanding: [
      {
        ...
        desc: "जब काम करने वाला हीरो सबसे आगे खड़ा हो, तो उसे <b>Active Voice</b> कहते हैं!<br>" +
              "📐 <b>स्ट्रक्चर (Structure):</b><br>" +
              "<code>Subject (काम करने वाला हीरो) + Verb (काम) + Object (जिस पर काम हुआ)</code><br>" +
              "👉 <b>उदाहरण 1:</b> <i>Rohan kicks the ball.</i> (Rohan [Subject] + kicks [Verb] + the ball [Object])<br>" +
              "👉 <b>उदाहरण 2:</b> <i>The cat caught a mouse.</i> (The cat [Subject] + caught [Verb] + a mouse [Object])",
        tts: "एक्टिव वॉइस क्या होता है? इसका मतलब है काम करने वाला राजा यानी हीरो सबसे आगे रहेगा! इसका आसान स्ट्रक्चर याद रखो: सबसे पहले सब्जेक्ट यानी काम करने वाला हीरो, फिर वर्ब यानी काम वाला शब्द, और अंत में ऑब्जेक्ट यानी जिस चीज़ पर काम हुआ! जैसे पहले उदाहरण में देखो: रोहन किक्स द बॉल। यहाँ रोहन है सब्जेक्ट यानी हीरो, किक्स है वर्ब यानी काम, और द बॉल है ऑब्जेक्ट यानी चीज़! दूसरा उदाहरण देखो: द कैट कॉट अ माउस। बिल्ली है सब्जेक्ट, कॉट है वर्ब, और चूहा है ऑब्जेक्ट! जब भी सब्जेक्ट सबसे आगे खड़ा होकर काम करे, तो वो एक्टिव वॉइस होता है!"
      },
      {
        id: "und_passive",
        type: "concept",
        ...
        desc: "जब जिस खिलौने या चीज़ पर काम हुआ, वो आगे आ जाए तो उसे <b>Passive Voice</b> कहते हैं!<br>" +
              "📐 <b>स्ट्रक्चर (Structure):</b><br>" +
              "<code>Object (चीज़ आगे) + Helping Verb (is/am/are/was/were) + Verb 3rd form (V3) + by + Subject (पुराना हीरो)</code><br>" +
              "👉 <b>उदाहरण 1:</b> <i>The ball was kicked by Rohan.</i> (The ball [Object] + was [Helping Verb] + kicked [V3] + by + Rohan [Subject])<br>" +
              "👉 <b>उदाहरण 2:</b> <i>The mouse was caught by the cat.</i> (The mouse [Object] + was [Helping Verb] + caught [V3] + by + the cat [Subject])",
        tts: "पैसिव वॉइस क्या होता है? इसका मतलब है जिस चीज़ या खिलौने पर काम हुआ, वो आगे आकर बैठ जाएगी! इसका स्ट्रक्चर बहुत आसान है: सबसे पहले ऑब्जेक्ट यानी चीज़ आगे आएगी, फिर हेल्पिंग वर्ब जैसे इज़, आर या वॉज़ आएगा, उसके बाद वर्ब की तीसरी फॉर्म यानी वी थ्री लगेगी, फिर बाय आएगा, और अंत में सब्जेक्ट यानी पुराना हीरो पीछे चला जाएगा! जैसे पहले उदाहरण में देखो: द बॉल वॉज़ किक्ड बाय रोहन। यहाँ बॉल आगे आ गई, साथ में वॉज़ किक्ड लगा, फिर बाय रोहन आ गया! दूसरा उदाहरण देखो: द माउस वॉज़ कॉट बाय द कैट। नन्हा चूहा आगे आ गया, वॉज़ कॉट लगा, और बाय द कैट पीछे चला गया! जब ऑब्जेक्ट आगे बैठ जाए, तो वो पैसिव वॉइस होता है!"
      },
      {
        id: "und_voice_magic",
        type: "magic",
        ...
        meaning: "👉 कुर्सी की अदला-बदली और स्ट्रक्चर का बदलाव!",
        desc: "🔄 <b>बदलने का फॉर्मूला (Conversion Formula):</b><br>" +
              "<code>Active: Subject + Verb + Object</code><br>" +
              "⬇️ (क्रॉस एक्सचेंज यानी कैंची वाला जादू) ⬇️<br>" +
              "<code>Passive: Object + Helping Verb + Verb 3 (V3) + by + Subject</code><br><br>" +
              "👉 <b>स्टेप 1 (कुर्सी बदलो):</b> पीछे वाले Object को आगे लाओ और आगे वाले Subject को पीछे भेजो!<br>" +
              "👉 <b>स्टेप 2 (मददगार + V3):</b> काल (Tense) के अनुसार is/am/are/was/were लगाओ और हमेशा Verb की 3rd Form ही बैठाओ!<br>" +
              "👉 <b>स्टेप 3 (बाय जोड़ो):</b> पीछे जाने वाले हीरो के ठीक पहले 'by' लगा दो!<br>" +
              "✨ <i>उदा. Aman eats an apple → An apple is eaten by Aman!</i>",
        tts: "अब सीखो एक्टिव से पैसिव बनाने का 3-स्टेप जादुई फॉर्मूला और स्ट्रक्चर का बदलाव! इसे कहते हैं कैंची वाला क्रॉस एक्सचेंज जादू! एक्टिव में होता है: सब्जेक्ट प्लस वर्ब प्लस ऑब्जेक्ट। पैसिव में ये बदल जाता है: ऑब्जेक्ट प्लस हेल्पिंग वर्ब प्लस वर्ब थ्री प्लस बाय प्लस सब्जेक्ट! स्टेप नंबर एक: पीछे वाले ऑब्जेक्ट को आगे की कुर्सी पर बैठाओ और आगे वाले सब्जेक्ट को पीछे भेज दो! स्टेप नंबर दो: समय देखकर इज़, एम, आर, वॉज़ या वर लगाओ और काम वाले शब्द की हमेशा तीसरी फॉर्म यानी वी थ्री ही लगाओ, जैसे ईट का ईटन! और स्टेप नंबर तीन: पुराने हीरो के आगे प्यार से बाय लगा दो! जैसे देखो: अमन ईट्स एन एप्पल। जादू चलाओ: एन एप्पल आगे आया, इज़ ईटन लगा, और बाय अमन पीछे चला गया। बन गया ना पैसिव वॉइस!"
      }
    ],
    exercises: [
      {
   ...
   understanding: [
      {
        ...
        desc: "जब हम कोई काम करते हैं, तो वो काम कैसे, कहाँ या कब हुआ, यह बताने वाले जादुई शब्द को <b>Adverb</b> कहते हैं!<br>👉 <b>उदाहरण 1:</b> <i>The cheetah runs fast.</i> (चीता तेज़ दौड़ता है। दौड़ता कैसे है? Fast यानी तेज़!)<br>👉 <b>उदाहरण 2:</b> <i>The baby sleeps quietly.</i> (छोटा बच्चा चुपचाप सोता है। सोता कैसे है? Quietly यानी शांति से!)",
        tts: "एडवर्ब क्या होता है? इसका मतलब है काम वाले शब्द की जादुई तारीफ करने वाला मददगार शब्द! जैसे आप खेलते हो, दौड़ते हो या खाते हो, तो कोई पूछेगा ना कि कैसे दौड़े? कहाँ खेले? और कब खाया? जो शब्द इन सवालों का जवाब दे, वही एडवर्ब है! जैसे पहले उदाहरण में देखो: द चीता रन्स फास्ट, यानी चीता तेज़ दौड़ता है। यहाँ दौड़ने का काम कैसे हो रहा है? फास्ट यानी बहुत तेज़! तो फास्ट बन गया एडवर्ब। दूसरा उदाहरण देखो: द बेबी स्लीप्स क्वाइटली, यानी छोटा बच्चा चुपचाप सोता है। सोने का काम कैसे हुआ? क्वाइटली यानी बिना रोए शांति से! तो जो शब्द काम की खासियत बताए, वही एडवर्ब कहलाता है!"
      },
      {
        id: "und_adverb_kinds",
        type: "concept",
        badge: "नियम 2 (पाँच प्यारे दोस्त)",
        sentence: "Adverbs के प्रकार (Kinds)",
        meaning: "👉 Manner, Place, Time, Frequency और Degree",
        desc: "एडवर्ब के 5 सबसे प्यारे दोस्त होते हैं जो हर सवाल का जवाब देते हैं:<br>👉 <b>1. Manner (काम कैसे हुआ?):</b> <i>She dances gracefully.</i> (वह सुंदरता से नाचती है!)<br>👉 <b>2. Place (काम कहाँ हुआ?):</b> <i>Come inside.</i> (अंदर आ जाओ!)<br>👉 <b>3. Time (काम कब हुआ?):</b> <i>We will play tomorrow.</i> (हम कल खेलेंगे!)<br>👉 <b>4. Frequency (कितनी बार हुआ?):</b> <i>I brush daily.</i> (मैं रोज़ ब्रश करता हूँ!)<br>👉 <b>5. Degree (कितना ज्यादा हुआ?):</b> <i>Ice cream is very cold.</i> (आइसक्रीम बहुत ठंडी है!)",
        tts: "एडवर्ब के प्रकार यानी इसके पाँच प्यारे दोस्त! जब भी वाक्य आए, बस ये पाँच सवाल पूछो: पहला दोस्त है मैनर, यानी काम कैसे हुआ? जैसे शी डांसेस ग्रेसफुली, वह बहुत सुंदरता से नाचती है! दूसरा दोस्त है प्लेस, यानी काम कहाँ हुआ? जैसे कम इनसाइड, यानी अंदर आ जाओ! तीसरा दोस्त है टाइम, यानी काम कब हुआ? जैसे वी विल प्ले टुमॉरो, हम कल खेलेंगे! चौथा दोस्त है फ्रीक्वेंसी, यानी काम कितनी बार हुआ? जैसे आई ब्रश डेली, मैं रोज़ दाँत साफ़ करता हूँ! और पाँचवाँ दोस्त है डिग्री, यानी काम कितना ज्यादा हुआ? जैसे द आइसक्रीम इज़ वेरी कोल्ड, आइसक्रीम बहुत ठंडी है! बस कैसे, कहाँ, कब, कितनी बार और कितना ज्यादा पूछो, प्रकार तुरंत पता चल जाएगा!"
      },
      {
        id: "und_ly_magic",
        type: "magic",
        ...
        desc: "👉 <b>सीक्रेट ट्रिक:</b> किसी भी शब्द के पीछे <b>-ly</b> लगा दिखे, तो समझ जाओ कि वो काम करने का तरीका (Manner) बता रहा है!<br>✨ <i>Slow (धीमा) + ly = Slowly (धीमे-धीमे चलना)</i><br>✨ <i>Loud (ज़ोर से) + ly = Loudly (ज़ोर-ज़ोर से बोलना)</i><br>✨ <i>Sweet (मीठा) + ly = Sweetly (मीठी आवाज़ में गाना)</i>",
        tts: "अब सुनो परीक्षा में पूरे नंबर लाने का 90% वाला -ly जादुई फॉर्मूला! किसी भी शब्द के अंत में अगर एल वाई जुड़ा हुआ दिखे, तो नब्बे परसेंट वो काम करने का तरीका यानी एडवर्ब ऑफ मैनर होता है! जैसे कछुआ चलता है स्लो, उसमें एल वाई जोड़ दो तो बन गया स्लोली, यानी धीमे-धीमे चलना! शेर दहाड़ता है लाउड, एल वाई जोड़ दो तो बन गया लाउडली, यानी ज़ोर से दहाड़ना! कोयल गाती है स्वीट, एल वाई जोड़ दो तो बन गया स्वीटली, यानी मीठी आवाज़ में गाना! तो याद रखना बच्चों, एल वाई दिखा तो काम करने का तरीका पक्का!"
      }
    ],
    exercises: [
      {
